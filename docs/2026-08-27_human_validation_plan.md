...
| Independent third | **SCAN-B**, accession **GSE202203** (n=3,207) | RNA-seq, large n, treatment-stratified. Already used in Menegollo Fig 7H-L. **AMENDED 2026-08-31: the accession is GSE202203, not Brueffer's GSE96058/GSE81538.** Those two deposit log2(FPKM+0.1) only; with no counts they cannot carry mitoPPS, and amendment A1 blocks them exactly as it blocks the neoadjuvant cohorts. GSE202203 ships `RawCounts_gene_3207.tsv.gz`, so both co-primary instruments are possible. See `2026-08-31_scanb_bim_replication_declaration.md` section 1. |
